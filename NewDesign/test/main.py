...
from Node.Nodes.Playwright.PlaywrightFreelanceBidder import PlaywrightFreelanceBidder
from Node.Core.Form.Core.FormSerializer import FormSerializer  # Add this import

if __name__ == "__main__":
    my_node = PlaywrightFreelanceBidder(NodeConfig(id="1", type="playwright-freelance-bidder"))
    form =my_node.form()
